...
public class ProfileMenuFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        view.findViewById(R.id.buttonEdit).setOnClickListener(v -> {
            Navigation.findNavController(view).navigate(R.id.action_profileMenuFragment_to_profileEditFragment);
        });

        view.findViewById(R.id.buttonAdd).setOnClickListener(v -> {
            Navigation.findNavController(view).navigate(R.id.action_profileMenuFragment_to_profileAddFragment);
        });

        view.findViewById(R.id.buttonDelete).setOnClickListener(v -> {
            Navigation.findNavController(view).navigate(R.id.action_profileMenuFragment_to_profileDeleteFragment);
        });

        view.findViewById(R.id.buttonChange).setOnClickListener(v -> {
            Navigation.findNavController(view).navigate(R.id.action_profileMenuFragment_to_profileChangeFragment);
        });
    }
